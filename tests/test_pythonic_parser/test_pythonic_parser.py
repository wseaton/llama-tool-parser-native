...
class TestNativePythonicToolParser(unittest.TestCase):
    ...
    def test_process_tool_arguments_with_single_value_dicts(self):
        ...
        test_kwargs = {
            ...
            "address": {"street": "123 Main St", "city": "New York"},  # Should not change this dict
    ...
    def test_process_tool_arguments_with_nested_structure(self):
        ...
        test_kwargs = {
            "user": {
                "profile": {"name": "John"}  # Nested single-value dict, extracted from profile
            },
            "metadata": {"timestamp": 1621234567}  # Single-value dict, should extract value
        }
    ...
    def test_extract_tool_calls_with_tools(self, mock_parse_tools):
        ...
        mock_parse_tools.return_value = [
            {
                ...
                "kwargs": {
                    ...
                    "options": {"limit": 5}  # Single-value dict that should be simplified
                }
            },
            {
                "name": "calculate",
        ...
        # Call the function
        result = self.parser.extract_tool_calls("some model output with tools", mock_request)
        ...
        self.assertEqual(search_args["options"], 5)  # Should be simplified from {"limit": 5}
